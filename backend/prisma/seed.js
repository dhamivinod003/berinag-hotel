...
async function main() {
    ...
    const resort = await prisma.resort.upsert({
        ...
        create: {
            ...
            description: "A premium Himalayan retreat in the heart of Pithoragarh, Uttarakhand. Wake up to misty mountain views, dine by the water, and let the Himalayas slow you down.",
    ...
    await prisma.staff.upsert({
        where: { resortId_email: { resortId: resort.id, email: "owner@sunandwaterresort.com" } },
        update: { passwordHash, roleKey: "OWNER", status: "ACTIVE", emailVerifiedAt: new Date() },
        create: {
            resortId: resort.id,
    ...
    // Also seed a manager + reception + housekeeping for demo.
    await prisma.staff.upsert({
        where: { resortId_email: { resortId: resort.id, email: "manager@sunandwaterresort.com" } },
        update: { passwordHash, roleKey: "MANAGER", status: "ACTIVE", emailVerifiedAt: new Date() },
        create: {
            resortId: resort.id,
    ...
    await prisma.staff.upsert({
        where: { resortId_email: { resortId: resort.id, email: "reception@sunandwaterresort.com" } },
        update: { passwordHash, roleKey: "RECEPTION", status: "ACTIVE", emailVerifiedAt: new Date() },
        create: {
            resortId: resort.id,
    ...
    const roomTypeDefs = [
        {
            ...
            description: "Our signature Deluxe Room offers sweeping views of the Himalayan foothills, a private balcony, and warm wood interiors. Perfect for couples and solo travellers looking to unwind.",
            maxAdults: 2,
            maxChildren: 1,
            maxOccupancy: 3,
            ...
            totalUnits: 10,
            displayOrder: 1,
            coverImage: "https://images.unsplash.com/photo-1631049307264-da0ec9d70304?auto=format&fit=crop&w=1200&q=80",
            gallery: [
        ...
        },
        {
            ...
            description: "Step up to a Premium Room with a larger layout, premium king bedding, panoramic windows, and an upgraded bath.",
            maxAdults: 2,
            maxChildren: 1,
            maxOccupancy: 3,
            bedConfiguration: "1 King Bed",
        ...
        },
        {
            ...
            description: "Our Family Suite is built for togetherness. Two bedrooms, a cosy lounge, and a wide mountain-facing terrace make this the obvious choice for families travelling through Kumaon.",
            maxAdults: 4,
            maxChildren: 2,
            maxOccupancy: 6,
        ...
        },
        {
            ...
            description: "Our Luxury Cottages are tucked into the property's quietest corner — standalone, private, and finished with a fireplace, deep tub, and a private sit-out under the stars.",
            maxAdults: 2,
            maxChildren: 1,
            maxOccupancy: 3,
            bedConfiguration: "1 King Bed",
            ...
            totalUnits: 2,
            displayOrder: 4,
            coverImage: "https://images.unsplash.com/photo-1518733057094-95b53143d2a7?auto=format&fit=crop&w=1200&q=80",
            gallery: [
    ...
    const reviewDefs = [
        {
            ...
            rating: 5,
            content: "Amazing stay! The view, food and hospitality were beyond our expectations. Will definitely visit again. The staff made us feel like family.",
        ...
        },
        {
            ...
            rating: 5,
            content: "Beautiful property with a peaceful environment. Perfect for family vacations. The cottage was spotless and the food was outstanding.",
        ...
        },
        {
            ...
            rating: 5,
            content: "Very clean rooms, great service and the staff is very polite and helpful. The pool at sunset is something I will remember for a long time.",
    ...
    await prisma.websiteSection.upsert({
        ...
        create: {
            ...
            content: JSON.stringify({
                ...
                subheadline: "Experience the perfect blend of nature, comfort and warm hospitality in Pithoragarh.",
                imageUrl: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&w=2400&q=80",
    ...
    console.log("Owner login:  owner@sunandwaterresort.com / changeme123");
}
main()
    .catch((err) => {
    console.error(err);
